...
Pre-health checkup data: Includes age and BMI (Body Mass Index) before policy cover. 

Personal details data: Contains number of dependents, smoking status, geographic location, and more. 
...
✅ Python for data analysis ✅ Pandas & NumPy for data cleaning & statistical calculations ✅ Seaborn & Matplotlib for data visualization ✅ Jupyter Notebook for interactive analysis 
...
In 2026, data-driven decision-making remains a cornerstone of the health insurance industry, and this MediBuddy capstone project underscores how predictive analytics can refine risk management. By integrating pre-health checkup data with personal demographics, the analysis demonstrates that while gender is not a significant factor in policy extensions, high-risk variables such as smoking status, elevated BMI, and advanced age are direct drivers of increased claim amounts. To maintain profitability and competitive advantage, it is recommended that the company transition toward a personalized premium model that incentivizes healthy lifestyles through BMI-based discounts and adjusts for regional health cost variations. Ultimately, leveraging these Python-based insights allows for the creation of more equitable, data-backed policies that balance policyholder needs with institutional risk control. 
